...
freq <- freq[head(ord, n = 10000)] ## top 50 words
...
bi.freq <- bi.freq[head(bi.ord, n = 10000)]
...
tri.freq <- tri.freq[head(tri.ord, n = 10000)]
...
quad.freq <- quad.freq[head(quad.ord, n = 10000)]
