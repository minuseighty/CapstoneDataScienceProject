...
sample.data("en_US.blogs.txt", "sample/sample.en_US.blogs.txt", 0.081)
sample.data("en_US.news.txt", "sample/sample.en_US.news.txt", 0.061)
sample.data("en_US.twitter.txt", "sample/sample.en_US.twitter.txt", 0.00698)
